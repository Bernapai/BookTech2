 ...
 export const BooksList =[
    ...
    description: "Introducción completa a JavaScript con prácticas y desafíos." ,
    price: 21,
    ...
    id:2,
     title: "Clean Code" ,
    description: "Arte de programar con elegancia y claridad." ,
    price: 35,
    ...
    description: "Extraer lo bueno, evitar las partes problemáticas clave." ,
    price: 35,
    ...
    id:4,
    title: "Phyton" ,
    description: "Guía completa para aprender programación en Python eficientemente." ,
    price: 27,
